...
import { App, createApp as createClientApp, createSSRApp, h } from 'kdu'
...
function newApp(): App {
  return import.meta.env.PROD
    ? createSSRApp(KduViteApp)
    : createClientApp(KduViteApp)
}
...
function handleHMR(router: Router): void {
  ...
  if (import.meta.hot) {
    // hot reload pageData
    import.meta.hot!.on('kduvite:pageData', (payload) => {
